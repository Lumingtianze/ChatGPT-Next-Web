...
const ar: PartialLocaleType = {
  ...
  Error: {
    Unauthorized: isApp
    ? `😆 واجهت المحادثة بعض المشكلات، لا داعي للذعر:
    \\ 1️⃣ إذا كنت ترغب في استهلاك موارد OpenAI الخاصة بك، فانقر [هنا](/#/settings) لتعديل الإعدادات ⚙️`
   : `😆 واجهت المحادثة بعض المشكلات، لا داعي للذعر:
    \ 1️⃣ انقر [هنا](/#/auth) لإدخال مفتاح الوصول 🔑
    \ 2️⃣ إذا كنت ترغب في استهلاك موارد OpenAI الخاصة بك، فانقر [هنا](/#/settings) لتعديل الإعدادات ⚙️
    `
  },
  Auth: {
