...
const es: PartialLocaleType = {
  ...
  Error: {
    Unauthorized: isApp
    ? `😆 La conversación ha tenido algunos problemas, no te preocupes:
    \\ 1️⃣ Si quieres usar tus propios recursos de OpenAI, haz clic [aquí](/#/settings) para cambiar la configuración ⚙️`
   : `😆 La conversación ha tenido algunos problemas, no te preocupes:
    \ 1️⃣ Haz clic [aquí](/#/auth) para introducir la clave de acceso 🔑
    \ 2️⃣ Si quieres usar tus propios recursos de OpenAI, haz clic [aquí](/#/settings) para cambiar la configuración ⚙️
    `
  },
  Auth: {
