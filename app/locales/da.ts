...
const da: PartialLocaleType = {
  ...
  Error: {
    Unauthorized: isApp
     ? `😆 Ups, der er et problem. Ingen bekymringer:
    \\ 1️⃣ Vil du bruge dine egne OpenAI-ressourcer? [Klik her](/#/settings) for at ændre indstillinger ⚙️`
     : `😆 Ups, der er et problem. Lad os løse det:
    \ 1️⃣ [Klik her](/#/auth) for at indtaste din nøgle 🔑
    \ 2️⃣ Vil du bruge dine egne OpenAI-ressourcer? [Klik her](/#/settings) for at ændre indstillinger ⚙️
    `,
  },
  Auth: {
    Return: "Tilbage",
