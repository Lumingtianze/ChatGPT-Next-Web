...
const it: PartialLocaleType = {
  ...
  Error: {
    Unauthorized: isApp
    ? `😆 La conversazione ha riscontrato alcuni problemi, niente panico:
    \\ 1️⃣ Se desideri utilizzare le tue risorse OpenAI, fai clic [qui](/#/settings) per modificare le impostazioni ⚙️`
   : `😆 La conversazione ha riscontrato alcuni problemi, niente panico:
    \ 1️⃣ Fai clic [qui](/#/auth) per inserire la chiave di accesso 🔑
    \ 2️⃣ Se desideri utilizzare le tue risorse OpenAI, fai clic [qui](/#/settings) per modificare le impostazioni ⚙️
    `
  },
  Auth: {
