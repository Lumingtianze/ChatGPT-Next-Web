...
const bn: PartialLocaleType = {
  ...
  Error: {
    Unauthorized: isApp
    ? `😆 কথোপকথনে কিছু সমস্যা হয়েছে, আতঙ্কিত হবেন না:
    \\ 1️⃣ আপনি যদি নিজের OpenAI সংস্থানগুলি ব্যবহার করতে চান তবে সেটিংস পরিবর্তন করতে [এখানে](/#/settings) ক্লিক করুন ⚙️`
   : `😆 কথোপকথনে কিছু সমস্যা হয়েছে, আতঙ্কিত হবেন না:
    \ 1️⃣ অ্যাক্সেস কী লিখতে [এখানে](/#/auth) ক্লিক করুন 🔑
    \ 2️⃣ আপনি যদি নিজের OpenAI সংস্থানগুলি ব্যবহার করতে চান তবে সেটিংস পরিবর্তন করতে [এখানে](/#/settings) ক্লিক করুন ⚙️
    `
  },
  Auth: {
