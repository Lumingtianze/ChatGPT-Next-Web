...
const ru: PartialLocaleType = {
  ...
  Error: {
    Unauthorized: isApp
    ? `😆 В диалоге возникли некоторые проблемы, не паникуйте:
    \\ 1️⃣ Если вы хотите использовать свои собственные ресурсы OpenAI, нажмите [здесь](/#/settings), чтобы изменить настройки ⚙️`
   : `😆 В диалоге возникли некоторые проблемы, не паникуйте:
    \ 1️⃣ Нажмите [здесь](/#/auth), чтобы ввести ключ доступа 🔑
    \ 2️⃣ Если вы хотите использовать свои собственные ресурсы OpenAI, нажмите [здесь](/#/settings), чтобы изменить настройки ⚙️
    `
  },
  Auth: {
