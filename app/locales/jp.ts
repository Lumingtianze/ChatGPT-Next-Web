...
const jp: PartialLocaleType = {
  ...
  Error: {
    Unauthorized: isApp
    ? `😆 会話に問題が発生しましたが、慌てないでください:
    \\ 1️⃣ 自分の OpenAI リソースを消費したい場合は、[ここ](/#/settings) をクリックして設定を変更してください ⚙️`
   : `😆 会話に問題が発生しましたが、慌てないでください:
    \ 1️⃣ [ここ](/#/auth) をクリックしてアクセスキーを入力してください 🔑
    \ 2️⃣ 自分の OpenAI リソースを消費したい場合は、[ここ](/#/settings) をクリックして設定を変更してください ⚙️
    `
  },
  Auth: {
    Title: "パスワードが必要です",
