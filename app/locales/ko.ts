...
const ko: PartialLocaleType = {
  ...
  Error: {
    Unauthorized: isApp
    ? `😆 대화에 문제가 발생했습니다. 당황하지 마세요:
    \\ 1️⃣ 자신의 OpenAI 리소스를 사용하려면 [여기](/#/settings)를 클릭하여 설정을 변경하세요 ⚙️`
   : `😆 대화에 문제가 발생했습니다. 당황하지 마세요:
    \ 1️⃣ [여기](/#/auth)를 클릭하여 액세스 키를 입력하세요 🔑
    \ 2️⃣ 자신의 OpenAI 리소스를 사용하려면 [여기](/#/settings)를 클릭하여 설정을 변경하세요 ⚙️
    `
  },
  Auth: {
    Title: "비밀번호 필요",
